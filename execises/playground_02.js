...
const numbers = {
  ...
  myObject.foo[2] = 6; // Which objects change? 1,2 
  myObject.baz = 6; // Which objects change? 1,2
  myObject.bar.b = 6; // Which objects change? 2
  myObject.qux = "two"; // Which objects change? 1, 2
  myObject.quux = "?"; // Which objects change? 1, 2, 3
  
  // ? 🐒 [Question]: Explain your decisions
  // Your answer:
  // myObjectCopied ist Ref von myObject
  // myObjectCopiedSpread ist eine Kopie von myObject
  // myObjectCopiedSpreadDeep ist eine Kopie mit neuen Prop von myObject
  ...
  // Your answer:
  // myObjectCopied === myObject ist eine Referenz auf das gleiche Objekt
  // myObjectCopiedSpread === myObject ist ein Kopie
